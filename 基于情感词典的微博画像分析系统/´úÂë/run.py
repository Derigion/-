...
stopwords=[line.strip() for line in open('../stopwords/stopword.txt', 'r',encoding='utf-8',errors='ignore').readlines()]
#结合了多个停用词表
...
#读取语料文本
pos_comment=get_file_content('../6000/pos')
neg_comment=get_file_content('../6000/neg')
